...
int main() {
    ...
    quick_heap_sort(random_vector, 50);
    ...
    std::vector<int> reversed_vector = make_reversed_array(10000);

    std::cout << std::endl << std::endl << "Reversed vector change:" << std::endl;
    test_speed(reversed_vector);


    std::vector<int> almost_sorted_vector = make_almost_sorted_array(10000);
